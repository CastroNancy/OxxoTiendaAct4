...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.caducidad, p.tamaño,p.precioVenta, pv.cantidad, p.tamaño
FROM productos p
INNER JOIN 
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->tamaño;  ?> <strong>$<?php echo number_format($producto->precioVenta, 2) ?></strong></td>
                        <td class="tamaño">$<?php echo number_format($subtotal, 2)  ?></td>
                    </tr>
                <?php } ?>
                <tr>
